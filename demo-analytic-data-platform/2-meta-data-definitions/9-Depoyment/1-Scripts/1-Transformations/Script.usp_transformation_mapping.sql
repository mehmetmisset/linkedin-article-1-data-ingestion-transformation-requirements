DROP PROCEDURE IF EXISTS ##usp_transformation_mapping;
GO
CREATE PROCEDURE ##usp_transformation_mapping
...
BEGIN  
  ...
  IF (@ip_is_testing = 0 /* If NOT in Testing-mode */) BEGIN
    INSERT INTO tsa_dta.tsa_transformation_mapping (id_transformation_mapping, id_transformation_part, id_attribute, is_in_group_by, tx_transformation_mapping) 
		SELECT id_transformation_mapping, id_transformation_part, id_attribute, is_in_group_by, tx_transformation_mapping
