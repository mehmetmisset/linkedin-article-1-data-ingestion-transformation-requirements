...
--
--    @id_development_status_prd CHAR(32) = (SELECT id_development_status FROM srd.development_status WHERE meta_is_active = 1 AND cd_development_status = 'PRD' AND id_model IN (SELECT id_model FROM mdm.current_model)),
--    @id_development_status_uat CHAR(32) = (SELECT id_development_status FROM srd.development_status WHERE meta_is_active = 1 AND cd_development_status = 'UAT' AND id_model IN (SELECT id_model FROM mdm.current_model)),
--    @id_development_status_dev CHAR(32) = (SELECT id_development_status FROM srd.development_status WHERE meta_is_active = 1 AND cd_development_status = 'DEV' AND id_model IN (SELECT id_model FROM mdm.current_model)),
